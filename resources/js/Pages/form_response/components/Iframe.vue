<template>
    <div class="patient-create">
        ...
        <div class="row justify-content-center">
            ...
            <div style="margin-top: 30px;" class="col-lg-6 card-box">
...
export default {
    ...
    methods: {
        ...
        selectFile(event) {
            ...
            let afterDot = photo['name'].substr( photo['name'].indexOf('.') + 1 );
            this.form.file_extension = afterDot;

            var reader = new FileReader()
            reader.onloadend = () => {
                // this.form.photo = reader.result;
                this.active_option.response_value = reader.result;
        ...
        save: function (params) {
            ...
            params['file_extension'] = this.form.file_extension
