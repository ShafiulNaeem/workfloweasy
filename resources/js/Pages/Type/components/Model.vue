            ...
            <div class="user-serchbox d-flex">
                ...
                <div class="searchbox ml-auto">
                    <nav class="navbar user-nav d-flex nav-mr-top">
                        <a v-if="editMode" :href="route('type.show',data.id)" class="btn btn-primary btn-sm cls rg-top-btn"><i class="fa fa-angle-left"></i>Go Back</a>
                        <a v-else :href="route(link)" class="btn btn-primary btn-sm cls rg-top-btn"><i class="fa fa-angle-left"></i> Types</a>
                    </nav>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        update: function (params) {
            ...
            this.$inertia.post('/type/' + params.id, data)
        },
        Edit(){
